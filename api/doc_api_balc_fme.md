 ...
 * 13/07/2026 : Version 1.6 - téléversement d'un lot de données communal au format BAL 1.5 (intégrant la nouvelle adresse API depuis juillet 2026), traitement de base avec contrôle à paramétrer
...
- [Téléchargement du projet FME version 1.6 - traitement par lot avec contrôle](https://geo.compiegnois.fr/documents/metiers/rva/API_BAL_LOT_FME_v16.zip)
